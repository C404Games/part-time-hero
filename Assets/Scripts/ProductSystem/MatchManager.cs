...
public class MatchManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        charactersLife[0] = GameObject.Find("Player").GetComponent<PlayerMovement>().getHealth();
        //Uncomment when we have more than one player playing at the same time (Photon multiplayer)
        /*
        charactersLife[1] = GameObject.Find("Player2").GetComponent<PlayerMovement>().getHealth();
        if (this.numberOfPlayers == 4)
        {
            charactersLife[2] = GameObject.Find("Player3").GetComponent<PlayerMovement>().getHealth();
            charactersLife[3] = GameObject.Find("Player4").GetComponent<PlayerMovement>().getHealth();
        }
        */

        charactersFrozen[0] = GameObject.Find("Player").GetComponent<PlayerMovement>().getIsFrozen();
        //Uncomment when we have more than one player playing at the same time (Photon multiplayer)
        /*
        charactersFrozen[1] = GameObject.Find("Player2").GetComponent<PlayerMovement>().getIsFrozen();
        if (this.numberOfPlayers == 4)
        {
            charactersFrozen[2] = GameObject.Find("Player3").GetComponent<PlayerMovement>().getIsFrozen();
            charactersFrozen[3] = GameObject.Find("Player4").GetComponent<PlayerMovement>().getIsFrozen();
        }
        */

        if (numberOfPlayers == 1)
        {
            this.punctuationTeam1 = GameObject.Find("Player").GetComponent<PlayerMovement>().getPunctuation();
        } else if (numberOfPlayers == 2)
        {
            this.punctuationTeam1 = GameObject.Find("Player").GetComponent<PlayerMovement>().getPunctuation();
            this.punctuationTeam2 = GameObject.Find("Player2").GetComponent<PlayerMovement>().getPunctuation();
        } else if (numberOfPlayers == 4)
        {
            this.punctuationTeam1 = GameObject.Find("Player").GetComponent<PlayerMovement>().getPunctuation();
            this.punctuationTeam2 = GameObject.Find("Player3").GetComponent<PlayerMovement>().getPunctuation();
        }
    }
